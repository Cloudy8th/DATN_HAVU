          ...
          <div class="bg-white p-4 p-md-5 rounded shadow-sm">
              ...
              <div class="col-12">
                <div class="text-center mb-5">
                  <router-link :to="{ name: 'HomePage' }">
                    <img src="@/assets/imgs/logo.jpg" alt="Logo" width="150" />
                  </router-link>
                </div>
              </div>
            </div>
            <form @submit.prevent="onSubmit">
              <div class="row gy-3 gy-md-4 overflow-hidden">
                <div class="col-12">
                  <label for="email" class="d-block form-label"
                ...
                <div class="col-12">
                  <label for="password" class="d-block form-label"
                ...
                <div class="col-12">
                  <label for="confirmPassword" class="d-block form-label"
