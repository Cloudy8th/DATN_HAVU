...
const filterProduct = async () => {
  if (productIdSearch.value) {
    ...
    if (!uuidRegex.test(productIdSearch.value)) {
      dialog("Lỗi", "error", "Mã sản phẩm không hợp lệ, vui lòng kiểm tra lại");
      return;
    }
  }
        ...
        <tr>
          ...
          <th scope="col" class="th-sort" @click="sortBy('title')">
            ...
            <i
              ...
              :class="[
                'fa-solid',
                title === 'desc' ? 'fa-sort-down' : 'fa-sort-up',
              ]"
            ></i>
          </th>
          ...
          <th scope="col" class="th-sort" @click="sortBy('salePrice')">
            ...
            <i
              ...
              :class="[
                'fa-solid',
                price === 'desc' ? 'fa-sort-down' : 'fa-sort-up',
              ]"
            ></i>
          </th>
          <th scope="col" class="th-sort" @click="sortBy('discount')">
            ...
            <i
              ...
              :class="[
                'fa-solid',
                discount === 'desc' ? 'fa-sort-down' : 'fa-sort-up',
              ]"
            ></i>
          </th>
